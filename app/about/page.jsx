  ...
  return (
    <section className="flex flex-col justify-center items-center text-center relative overflow-hidden p-5 pt-20 pb-32">
      ...
      <h1 className="text-4xl md:text-5xl mb-5 text-white z-10">
        About Al Azhar
        <br />
        <span className="text-mint-green">Computer Engineering College</span>
      </h1>
      <p className="text-lg md:text-xl max-w-3xl mb-8 z-10 text-white/80">
        Fostering innovation and technical excellence in electronics engineering
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          <div className="flex-1 space-y-6">
            <p className="text-lg text-white/80 leading-relaxed">
              At Al Azhar Computer Engineering College, our mission is to
              educate and empower the next generation of electronics engineers
              through a combination of theoretical knowledge and practical,
              hands-on experience.
            </p>
            <p className="text-lg text-white/80 leading-relaxed">
              We are committed to fostering innovation, critical thinking, and
              technical excellence, preparing our students to tackle the complex
            ...
            <div className="bg-electric-blue/10 border-l-4 border-electric-blue p-5 rounded">
              <p className="text-lg italic text-white m-0">
                "We believe in learning by creating, experimenting, and
                implementing. Our students don't just study electronics—they
          ...
          <div className="flex-1 min-w-[300px] h-[400px] bg-[#172a45] rounded-lg overflow-hidden relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-navy via-navy/70 to-transparent p-5">
              <div className="text-mint-green text-lg font-bold">
                Our State-of-the-Art Electronics Lab
              </div>
            </div>
          </div>
        </div>
  ...
  const timelineEvents = [
    {
      ...
      title: "Founding",
      description:
        "Al Azhar Computer Engineering College was established as a specialized institution focused on electronics and computer engineering.",
    },
    {
      year: 1997,
      title: "Research Center",
      description:
        "The Advanced Electronics Research Center was founded to promote cutting-edge research and industry collaboration.",
    },
    {
      year: 2005,
      title: "Curriculum Expansion",
      description:
        "Major curriculum revamp to include emerging technologies in IoT, renewable energy systems, and biomedical electronics.",
    },
    {
      year: 2018,
      title: "Innovation Hub",
      description:
        "Launched the Student Innovation Hub to foster entrepreneurship and support student projects with commercial potential.",
    },
  ];
            ...
            >
              ...
              <div className="lg:w-1/2 pl-10 lg:pl-0 lg:pr-10 lg:text-right lg:mr-auto">
                <div className="bg-white/5 p-5 rounded-lg border border-electric-blue/20 hover:border-electric-blue transition-all">
                  <div className="text-mint-green text-xl mb-2">
                    {event.year}
                  </div>
  ...
  const departments = [
    {
      ...
      description:
        "Specializing in designing and implementing systems that combine hardware and software for specific functions.",
      courses: ["Microcontroller Systems", "FPGA Design", "Real-Time Systems"],
    },
    {
      name: "Biomedical Electronics",
      description:
        "Focused on developing electronics solutions for healthcare, diagnostics, and medical treatment technologies.",
      courses: [
    ...
    },
    {
      ...
      description:
        "Dedicated to innovative solutions in power generation, distribution, and renewable energy technologies.",
      courses: [
        "Power Electronics",
    ...
    },
    {
      ...
      description:
        "Explores wireless communication, networking technologies, and signal processing for modern communication systems.",
      courses: [
        "RF Circuit Design",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {departments.map((dept, index) => (
            ...
            >
              ...
              <div className="mb-2 text-mint-green font-medium">
                Featured Courses:
              </div>
  ...
  const facilities = [
    {
      ...
      description:
        "State-of-the-art facility equipped with precision measurement instruments, PCB prototyping equipment, and analog/digital design tools.",
      icon: "🔌",
    },
    {
      name: "Robotics Workshop",
      description:
        "Specialized space for building and testing robotic systems with 3D printers, CNC machines, and embedded systems development kits.",
      icon: "🤖",
    },
    {
      name: "Biomedical Instrumentation Lab",
      description:
        "Equipped with medical sensors, biosignal acquisition systems, and tools for developing medical devices and prototypes.",
      icon: "❤️",
    },
    {
      name: "Power Systems Laboratory",
      description:
        "Features power electronics workstations, renewable energy simulators, and grid integration testing equipment.",
      icon: "⚡",
    },
    {
      name: "Anechoic Chamber",
      description:
        "Specialized room for testing RF devices, antennas, and electromagnetic compatibility of electronic devices.",
      icon: "📡",
    },
    {
      name: "Student Innovation Hub",
      description:
        "Collaborative workspace with development tools, component libraries, and mentorship for student-led projects and startups.",
      icon: "💡",
    },
  ];
          ...
          {facultyMembers.map((member, index) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="text-mint-green font-medium mb-1">
                  {member.position}
                </div>
  ...
  const faqs = [
    {
      ...
      answer:
        "Our college combines theoretical education with hands-on project-based learning. We maintain strong industry partnerships that provide real-world experience opportunities and our specialized labs are equipped with cutting-edge technology for practical skills development.",
    },
    {
      question: "How can I see the student projects?",
      answer:
        "Student projects are regularly showcased on our website and during our bi-annual Electronics Showcase Event. You can also schedule a campus visit to see current projects in our labs and innovation spaces.",
    },
    {
      question: "Are there opportunities for research collaboration?",
      answer:
        "Yes, we actively encourage research collaborations with industry partners and other academic institutions. Contact our Research Department for specific inquiries and potential partnership opportunities.",
    },
    {
      question: "How do students get involved in project teams?",
      answer:
        "First-year students are introduced to project teams during orientation. Students can join existing teams or form new ones based on their interests. Each team is supervised by faculty advisors who provide guidance and support throughout the project lifecycle.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-10 text-center text-white/80">
          <p>
            ...
            <Link href="/contact" className="text-mint-green hover:underline">
              contact us
            </Link>
            .
          </p>
