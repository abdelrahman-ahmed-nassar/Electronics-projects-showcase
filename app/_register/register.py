...
SUPABASE_URL = "https://ajplnleilpczkgumlwyl.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFqcGxubGVpbHBjemtndW1sd3lsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NDU1NDY0MiwiZXhwIjoyMDYwMTMwNjQyfQ.s7zIR1AcS_LZeGE5t1rvUJXZ9DrAH0wij3Weth3V3gc"  # Important: use the service role key, not anon key
